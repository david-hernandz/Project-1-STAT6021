...
ggplot(df, aes(x = cut, y = carat)) +
  geom_violin(aes(fill = cut), show.legend = FALSE) +
  theme_minimal() +
  labs(title = "Carat vs. Cut", x = "Cut", y = "Carat")
```
...
ggplot(df, aes(x = clarity, fill = color)) +
  ...
  theme_minimal() +
  labs(title = "Clarity vs. Color", x = "Clarity", y = "Proportion")
```
...
ggplot(df, aes(x = clarity, fill = cut)) +
  ...
  theme_minimal() +
  labs(title = "Clarity vs. Cut", x = "Clarity", y = "Count")
```
...
ggplot(df, aes(x = color, fill = cut)) +
  ...
  theme_minimal() +
  labs(title = "Cut vs. Color", x = "Color", y = "Count")
```
